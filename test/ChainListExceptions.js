...
contract('ChainList', function(accounts) {
  ...
  // test case: buying an article that you are selling
  it("should throw an execption if you try to buy your own article", function() {
    return ChainList.deployed().then(function(instance) {
      chainListInstance = instance;
    ...
    .catch(function(error) {
      ...
      //make sure the contract was not altered
  ...
  it("should throw an execption if try and buy an article for a value that is different from the price", function() {
    return ChainList.deployed().then(function(instance) {
      chainListInstance = instance;
      return chainListInstance.buyArticle({
        from: buyer,
